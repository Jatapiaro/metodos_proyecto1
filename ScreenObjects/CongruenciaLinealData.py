    ...
    def __init__(self,xn,xni,random):
        ...
        for i in range(l):
            self.my_table.add_row(
                ...
                [TextInput, {'text': str(int(xn[i])),'color_click': [.01, .77, .97, 1], 'readonly':True, 'size_hint_x': 1}],
                [TextInput, {'text': str(int(xni[i])),'color_click': [.01, .77, .97, 1], 'readonly':True, 'size_hint_x': 1}],
